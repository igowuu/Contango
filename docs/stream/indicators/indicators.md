...
Often, strategies use indicator states (price below or above an indicator) rather than looking for specific values. State machines for each of the indicators are included. For example, a few states:
