...
The metric system generates metrics to help with both graphing (visual analysis) & strategy optimization. It contains the necessary information, derived from raw events, to determine profitability, risk, and factor out any results that indicate overfitting or unreliability.
...
See [metrics reference](../../reference/trading/metrics/metrics.md)
