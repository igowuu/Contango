# tests/unit/trading/test_optimizer/test_analysis/builder_tests/build_trades.py — part of Contango, a parameterized backtesting & execution framework
...
from contango.trading.execution.engine import (
    AcceptedFillEvent, 
    ExecutionData, 
    MarketDataEvent, 
    OrderEvent,
...
from contango.trading.optimizer.analysis.builder import _build_trades
