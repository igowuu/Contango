# tests/unit/trading/test_optimizer/test_analysis/calculator_tests/test_trades.py — part of Contango, a parameterized backtesting & execution framework
...
from contango.trading.optimizer.analysis.context import TradePoint
from contango.trading.optimizer.analysis.calculators.trades import (
