# tests/unit/trading/test_optimizer/test_analysis/calculator_tests/test_risk.py — part of Contango, a parameterized backtesting & execution framework
...
from contango.trading.optimizer.analysis.context import EquityPoint
from contango.trading.optimizer.analysis.calculators.risk import (
    _get_annual_return,
    _get_calmar_ratio,
